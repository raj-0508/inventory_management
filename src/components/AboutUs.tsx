...
const defaultValues: NonNullable<AboutUsProps["values"]> = [
  {
    title: "Innovation",
    description:
...
export default function AboutUs1() {
  const aboutData = {
    title: "Built for accurate inventory",
    subtitle:
      "TrackNest gives teams a single source of truth for products, stock, and operations.",
    mission:
      "Make inventory control effortless. Search products instantly, add and update details confidently, and keep quantities accurate in real time—without spreadsheets.",
    vision:
      "Reliable stock management for every business: fast, transparent, and scalable across teams and locations.",
    values: defaultValues,
    className: "relative overflow-hidden py-20",
  } satisfies Required<Pick<AboutUsProps, "title" | "subtitle" | "mission" | "vision" | "values">> & { className: string };
  ...
  return (
    <section className="relative w-full overflow-hidden pt-20">
      <Spotlight
        gradientFirst="radial-gradient(68.54% 68.72% at 55.02% 31.46%, hsla(220, 100%, 60%, 0.08) 0, hsla(221, 100%, 55%, 0.04) 50%, hsla(222, 100%, 45%, 0) 80%)"
        gradientSecond="radial-gradient(50% 50% at 50% 50%, hsla(223, 100%, 85%, 0.08) 0, hsla(224, 100%, 55%, 0.04) 80%, transparent 100%)"
        gradientThird="radial-gradient(50% 50% at 50% 50%, hsla(225, 100%, 85%, 0.06) 0, hsla(226, 100%, 85%, 0.06) 80%, transparent 100%)"
      />
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-muted-foreground mt-6 text-xl">{aboutData.subtitle}</p>
        </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground text-lg leading-relaxed">{aboutData.mission}</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">{aboutData.vision}</p>
            </motion.div>
          </motion.div>
        </div>
